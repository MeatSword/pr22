...
class Adapter extends BaseAdapter
{
    ...
    public Adapter(Context context, int cols, int rows)
    {
        mContext = context;
        mCols = cols;
        mRows = rows;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (arrStatus.get(position))
        {
            case CELL_OPEN:
                ...
                break;
            case CELL_CLOSE:
                view.setImageResource(R.drawable.pict);
                break;
            default:
                view.setImageResource(R.drawable.pict2);
        }
